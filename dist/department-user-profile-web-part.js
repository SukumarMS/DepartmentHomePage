define("50538410-69de-4f95-94a3-2370e8015e32_0.0.1", ["jquery","@microsoft/sp-core-library","@microsoft/sp-webpart-base","@microsoft/sp-property-pane","DepartmentUserProfileWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_47__, __WEBPACK_EXTERNAL_MODULE_48__, __WEBPACK_EXTERNAL_MODULE_49__, __WEBPACK_EXTERNAL_MODULE_83__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_DepartmentUserProfileWebPartStrings__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_DepartmentUserProfileWebPartStrings___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_DepartmentUserProfileWebPartStrings__);
...
var DepartmentUserProfileWebPart = /** @class */ (function (_super) {
    ...
    DepartmentUserProfileWebPart.prototype.getDocuments = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.site.getDocumentLibraries(this.context.pageContext.web.absoluteUrl).then(function (data) {
                    var strTitle = "";
    ...
    DepartmentUserProfileWebPart.prototype.addDocuments = function () {
        ...
        if (isAllfield) {
            ...
            __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl($('#ddlDocLibrary').find(":selected").text()).files.add(file_1.name, file_1, true)
                .then(function (result) {
                console.log(file_1.name + " upload successfully!");
                result.file.listItemAllFields.get().then(function (listItemAllFields) {
                    __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle($('#ddlDocLibrary').find(":selected").text()).items
    ...
    DepartmentUserProfileWebPart.prototype.getuserdetails = function () {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.profiles.myProperties.get().then(function (result) {
    ...
    DepartmentUserProfileWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: __WEBPACK_IMPORTED_MODULE_3_DepartmentUserProfileWebPartStrings__["PropertyPaneDescription"]
                    },
                    groups: [
                        {
                            groupName: __WEBPACK_IMPORTED_MODULE_3_DepartmentUserProfileWebPartStrings__["BasicGroupName"],
                            groupFields: [
                                Object(__WEBPACK_IMPORTED_MODULE_2__microsoft_sp_property_pane__["PropertyPaneTextField"])('description', {
                                    label: __WEBPACK_IMPORTED_MODULE_3_DepartmentUserProfileWebPartStrings__["DescriptionFieldLabel"]
                                })
                            ]
                        }
                    ]
...
/* harmony default export */ __webpack_exports__["default"] = (DepartmentUserProfileWebPart);
...
/***/ })
/******/ ])});;
//# sourceMappingURL=department-user-profile-web-part.js.map